...
enum DisplayOption
{
    EXAMPLE_SCENE,   ///< Access the example scene
...
{
    static const unsigned int WINDOW_WIDTH   = 800; ///< Window width work only for PC Platform
    static const unsigned int WINDOW_HEIGHT  = 600; ///< Window height work only for PC Platform
	...
	static const DisplayOption LAUNCH_OPTION = DisplayOption::EXAMPLE_SCENE; ///< Represents the first scene to be launched
	...
	static const int		DEFAULT_BUTTON_TEXT_SIZE               = 20;
    ...
    static std::string const GAME_NAME     = "Box 2D Example"; ///< Windows title name
